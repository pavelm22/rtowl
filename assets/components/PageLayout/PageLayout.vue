...
<template>
  <transition
    ...
    <div
        v-if="show"
        class="fixed inset-0 pointer-events-auto overflow-scroll bg-transparent z-10"
        :style="{ top: 'var(--header-height)', height: 'calc(var(--app-height) - var(--header-height))' }">
      <div class="h-full overflow-auto">
        <slot></slot>

        <div class="relative bg-white">
          <div class="absolute bottom-0 left-0 right-0 flex justify-center p-4 z-10 pointer-events-auto">
